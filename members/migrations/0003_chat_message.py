...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('members', '0002_remove_message_room_remove_message_sender_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='members.chat', verbose_name='Чат')),
            ],
            options={
                'ordering': ['pub_date'],
            },
